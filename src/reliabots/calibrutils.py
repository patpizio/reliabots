...
def reliabubble(scores, y_test, num_bins=10, size_max=20, font_size=12, title=None, width=700, height=500):
    ...
    fig = px.scatter(x=confidence, y=accuracy, size=counts, width=width, height=height,
        labels={
            'x':'probability',
            'y':'accuracy'
        },
